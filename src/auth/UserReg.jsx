    ...
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 py-12 px-4 relative overflow-hidden">
      ...
      <div className="bg-white/95 backdrop-blur-lg p-8 md:p-10 rounded-3xl shadow-2xl w-full max-w-md relative z-10 transform transition-all duration-500 hover:shadow-purple-500/50">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-indigo-500 to-pink-500 rounded-full mb-4 shadow-lg">
        ...
        <div className="flex flex-col gap-4">
          ...
          {!isLogin && (
            <div className="relative group animate-slide-down">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-purple-500 focus:ring-4 focus:ring-purple-100 transition-all duration-300"
              />
            </div>
          )}
          ...
          <div className="relative group animate-slide-down" style={{animationDelay: !isLogin ? '0.2s' : '0.1s'}}>
            ...
            <input
              ...
              className="w-full pl-12 pr-12 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-purple-500 focus:ring-4 focus:ring-purple-100 transition-all duration-300"
            />
            <button
              type="button"
          ...
          <button
            ...
            disabled={loading}
            className={`bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-xl hover:scale-105 transition-all duration-300 mt-4 relative overflow-hidden group ${
        ...
        <p className="text-gray-600 text-sm mt-6 text-center">
          ...
          <span 
            className="text-transparent bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text font-semibold cursor-pointer hover:underline"
            onClick={toggleMode}
          >
